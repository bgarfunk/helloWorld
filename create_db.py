...
with app.app_context():
    ...
    users = [
        ...
        {'username': 'bgarfunk', 'email': 'bgarfunk@umd.edu', 'first_name': 'Brian', 'last_name': 'Garfunkel',
         'password': generate_password_hash('bgarfunk', method='pbkdf2:sha256'), 'role': 'STUDENT'}
    ]
